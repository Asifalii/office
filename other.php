...
$main_array['ampword'] = getAmpWord($conn, $main_array['q']);
...
<head>
    ...
    <script>
        ...
        var t = [];
        null != localStorage.getItem("search_history") && (t = JSON.parse(localStorage.getItem("search_history"))), 1 == 1 ? t.push(a) : t.indexOf(a) >= 0 && t.splice(t.indexOf(a), 1);
        ...
        function show_history() {
            ...
            var t = JSON.parse(localStorage.getItem('search_history'));
            Object.keys(t).forEach(k => (!t[k] && t[k] !== undefined) && delete t[k]);
            ...
            if (t.length > 10) {
                var div1 = document.getElementById('myInputautocomplete-list');

                div.innerHTML1 = '';
                var div_element1 = document.createElement("DIV");
                div_element1.innerHTML = '<a href="search_history.php"> See More...</a>';


                document.getElementById("myInputautocomplete-list").appendChild(div_element1);
...
<?php if (!empty($androidLink)) { ?>
    <div class="android_banner" id="mobile_banner_div"
         style="position: fixed; bottom:0px;margin-left:0px; z-index: 9999999999; width: 100%;">
        <button class="btn_default2 bdr_radius2" style="text-align: center;">
            <a href="https://play.google.com/store/apps/details?id=com.bdword.e2bdictionary" target="_blank">
                <img src="img/android-icon.png" alt="icon" width="30" height="30" style="position:absolute;">
        ...
        <div class="content_wrapper">
            ...
            <div class="search_fld">
                <form autocomplete="off" name="new_form" action="<?= $main_array['baseurl'] ?>" id="new_form">
                    <input type="text" id="q" name="q" value="<?= $main_array['q'] ?>" onfocus="show_history()"
                           autocomplete="on" required placeholder="Type English word/phrase"
            ...
            <div class="header_nav_collapse">
                ...
                <ul id="menu">
                    ...
                    <li>
                        <a href="<?= $main_array['baseurl'] ?>search_history.php" title="Browse Word Search History">Word
                            Search History</a>
                    </li>
                    <li>
...
<script type="text/javascript">
    ...
    function showAllStorageData(a) {
        ...
        if (a == 'search_history') {
            ...
            if (t.length > 10) {
                e += "<div class='clear_fixdiv'></div><button style='margin: 10px 0px 0px 0px;float: right;' class='btn_default4 bdr_radius2'><a href='search_history.php'>SEE ALL</a></button>";
            }
