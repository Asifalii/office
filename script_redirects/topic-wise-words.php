...
if(window.location.href == $hostname+'topic-wise-words.php'){
    
    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-topic-wise-words-business';

}else if($q){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-topic-wise-words-'+$q;
