...
var $s = $url.searchParams.get("season");
var $e = $url.searchParams.get("episode");
...
if(window.location.href == $hostname+'learn-ten-words-everyday.php'){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-learn-ten-words-everyday';

}else if($s && $e){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-learn-ten-words-everyday-season-'+$s+'-episode-'+$e;

}else if($s){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-learn-ten-words-everyday-season-'+$s;
