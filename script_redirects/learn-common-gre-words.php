...
var $q = $url.searchParams.get("topic");

if(window.location.href == $hostname+'learn-common-gre-words.php'){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-learn-common-gre-words';

}else if($q){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-learn-common-gre-words-'+$q;
