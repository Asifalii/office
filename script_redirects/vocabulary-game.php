...
if(window.location.href == $hostname+'vocabulary-game.php'){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-vocabulary-game';

}else if($s && $e){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-vocabulary-game-season-'+$s+'-episode-'+$e;

}else if($s){

    window.location.href = $hostname+'english-to-'+$lang+'-dictionary-vocabulary-game-season-'+$s;
