...
$main_array['url'] = 'https://' . $_SERVER['HTTP_HOST'];
...
$main_array['title'] = getIndexPageTitle($main_array['q'], $main_array['ulang']);
    ...
    <script>
        ...
        function show_history() {
            ...
            if (e.length > 5) {
                ...
                r.innerHTML = '<a href="<?= $main_array['baseurl'] ?>english-to-<?=$main_array['lang']?>-dictionary-search-history" style="display: block"> See More...</a>', document.getElementById("myInputautocomplete-list").appendChild(r)
            }
        }
        ...
        <button class="btn_default2 bdr_radius2" style="text-align: center;">
            <a href="<?php echo $androidLink; ?>" target="_blank">
                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                     data-src="<?= $contentUrl ?>img/android-icon.png" alt="icon" width="30px" height="30px"
...
<div id="site_wrapper">
            ...
            <div class="content_wrapper">
                ...
                <div class="logo_div">
                    <div class="header_logo">
                        <a href="<?= $main_array['baseurl'] ?>"><img
                                    src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                    data-src="<?= $url ?>"
                                    onerror="this.onerror=null; this.src='<?= $langLogo ?>'"
                                    alt="<?= strtoupper($main_array['logotext']) ?>" height="55px"
                                    style="margin-bottom: -15px;" loading="lazy"</a>
                    </div>
                    ...
                    <div class="mobile_logo" style="display: none">
                        <a href="<?= $main_array['baseurl'] ?>"><img
                                    ...
                                    alt="<?= strtoupper($main_array['logotext']) ?>" height="55px"
                                    style="margin-bottom: -15px;padding-left: 5px;padding-top: 5px;" loading="lazy"></a>
                    </div>
                    ...
                    <div class="search_fld" style="width: 100%;">
                        <form autocomplete="off" name="new_form" action="#" id="new_form">
                            ...
                            <input type="text" id="q" name="q" value="<?= $main_array['q'] ?>" onfocus="show_history()"
                                   autocomplete="off" required placeholder=" word"
                ...
                <div style="width: 100%;">
                    <div class="header_nav_collapse">
                        ...
                        <ul id="menu">
                            ...
                            <li>
                                <a href="<?= $main_array['baseurl'] ?>english-to-<?= $main_array['lang'] ?>-read-text-with-translation">Read
                                    Text</a>
                            </li>
                            <li>
                                <a href="<?= $main_array['baseurl'] ?>english-to-<?= $main_array['lang'] ?>-dictionary-vocabulary-game">Vocabulary
                                    Games</a>
                            </li>
                            <li>
                                <a href="<?= $main_array['baseurl'] ?>english-to-<?= $main_array['lang'] ?>-dictionary-learn-ten-words-everyday">Words
                                    Everyday</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= $main_array['baseurl'] ?>english-to-<?= $main_array['lang'] ?>-dictionary-browse-all-blogs"
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            <!-- type: "get", -->
            <!-- url: "https://server2.mcqstudy.com/get_word.php", -->
            ...
            <!-- success: function (data) { -->
                ...
                <!-- words_everyday_link.setAttribute('href', "<?=$main_array['baseurl']?>english-to-<?=$main_array['lang']?>-meaning-" + data); -->
                <!-- most_search_words_link.setAttribute('href', "<?=$main_array['baseurl']?>english-to-<?=$main_array['lang']?>-meaning-" + data); -->
            <!-- }, -->
            <!-- error: function () { -->
                <!-- console.log("error"); -->
            <!-- } -->
    ...
    <script src="https://server2.mcqstudy.com/bw22/bdword_js.js?pppooo"></script>
