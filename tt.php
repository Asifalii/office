...
$cache_lang_array = array_flip($cache_lang_array);
    ...
    if ($_GET['q'] && $_GET['lang']) {
        ...
        $main_loop_query = mysqli_query($conn, 'select word from asif where word="' . $_GET['q'] . '" limit 1');
        
    } else{
        $main_loop_query = mysqli_query($conn, 'select word from asif where word = "never"');
                                ...
                                $big_html .= "
                                                <div class='logo_div'>
                                                    <div class='header_logo'>
                                                            ...
                                                            $big_html .= '<img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $url . '"onerror="this.onerror=null; this.src=';
                                                            $big_html .= "'" . $langLogo . "'";
                                                            $big_html .= '"  alt="'.strtoupper($main_array['logotext']) .'"title="'.strtoupper($main_array['logotext']) .'"style="margin-bottom: -15px;"height="55px" loading="lazy">';           
                                                            $big_html .= "</a>
                                                    </div>
                        ...
                        <div class='content_wrapper top_margin'>
                                            ...
                                            <fieldset>
                                                " . str_replace('Bengali', 'Bangla', stripslashes($main_array['honetitle'])) . "
                                                        <div class='fieldset_body inner_details' style='font-size: initial'>";
                                                            ...
                                                            $big_html .= '
                                                            <span><div class="align_text  custom_font2">' . ucfirst(stripslashes($q)) . ' : 
                                                                </div>
                                                                <div class="align_text2">' . $y_bengali['mean'] . '
                                                                </div>
                                                                ...
                                                                <label class="img_align">Add to Favorite: <button class="icon_button" onclick="calFavs(\'' . $q . '\', 1)"><img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" height="35px" width="35px" data-src="' . $contentUrl . 'img/heart-add.png" title="Add To Favorites" loading="lazy"></button></label>                                       
                                                            </span>';
                                                            ?>
                                                            <?php
                                                            ...
                                                            if ($total_words > 1) {
                                                                ...
                                                                while ($extra_row = mysqli_fetch_assoc($extra_sql)) {
                                                                    $big_html .= '
                                                                    <span>
                                                                        <a href="' . $main_array['url'] . '/english-to-' . $main_array['lang'] . '-meaning-' . strtolower($extra_row['word']) . '" title="English to ' . str_replace("Bengali", "Bangla", $main_array['ulang']) . ' meaning of ' . $extra_row['word'] . '"><label>' . ucfirst($extra_row['word']) . '</label></a> - ' . $extra_row['mean'] . '</span>';
                                                                }
                                                            ...
                                                            while ($related_mean_row = mysqli_fetch_assoc($related_mean_query)) {
                                                                $big_html .= '
                                                                <span>
                                                                    <label>' . ucfirst($related_mean_row['word']) . ' :: </label>' . $related_mean_row['mean'] . '</span>';
                                                            }
                                                        ...
                                                        <div class='custom_margin2'></div>";
                                                            ...
                                                            if ($q) {
                                                                ...
                                                                $big_html .= "<div class='custom_margin2'>
                                                                            </div>
                            ...
                            $big_html .= '
                                        <div class="box_wrapper">
                                                    ...
                                                    '<div class="fieldset_body inner_details">
                                                        <div style="text-align: justify">
                                                            <span style = "word-break: initial;">
                                                                This is not just an ordinary English to ';
                                            ...
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-learn-prepositions"
                                                    title="Learn Prepositions by Photos">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/learn-prepositions-by-photos.webp"onerror="this.onerror=null; this.src=';
                                            ...
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-commonly-confused-words"
                                                    title="Commonly confused words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/commonly-confused-words.webp"onerror="this.onerror=null; this.src=';
                                            ...
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-form-of-verbs"
                                                    title="form of verbs">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/form-of-verbs.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/form-of-verbs.jpg'";
                                            $big_html .= '" alt="form of verbs" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-300-plus-toefl-words"
                                                    title="Learn 300+ TOEFL words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/tofel_words.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/tofel_words.jpg'";
                                            $big_html .= '" alt="Learn 300+ TOEFL words" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-fill-in-the-blanks-page-1"
                                                    title="Fill in the blanks">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/fill_in_the_gaps.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/fill_in_the_gaps.jpg'";
                                            $big_html .= '" alt="Fill in the blanks" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-topic-wise-words-animals"
                                                    title="Topic Wise Words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/topic_wise_words.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/topic_wise_words.jpg'";
                                            $big_html .= '" alt="Topic Wise Words" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-learn-3000-plus-common-words"
                                                    title="Learn 3000+ common words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/common_words.webp"onerror="this.onerror=null; this.src=';
                                            ...
                                            if ($main_array['lang'] == 'bengali' or $main_array['lang'] == 'bangla') {
                                                $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-grammar-post_id-25-cat-2"
                                                    title="Learn English Grammar">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/english_grammar.webp"onerror="this.onerror=null; this.src=';
                                                $big_html .= "'" . $contentUrl . "site_image/english_grammar.jpg'";
                                                $big_html .= '" alt="Learn English Grammar" width="100%" loading="lazy"></a></div>';
                                            }
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . $main_array['lang']. '-to-english-dictionary" id="words_everyday"
                                                    title="Words Everyday">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/words_everyday.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/words_everyday.jpg'";
                                            $big_html .= '" alt="Words Everyday" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . $main_array['lang']. '-to-english-dictionary" id="most_search_words"
                                                    title="Most Searched Words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/most_searched_words.webp"onerror="this.onerror=null; this.src=';
                                            $big_html .= "'" . $contentUrl . "site_image/most_searched_words.jpg'";
                                            $big_html .= '" alt="Most Searched Words" width="100%" loading="lazy"></a></div>';
                                    
                                            $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-learn-common-gre-words"
                                                    title="GRE Words">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/gre_words.webp"onerror="this.onerror=null; this.src=';
                                            ...
                                            if ($main_array['lang'] == 'bengali') {
                                                $big_html .= '<div><a href="https://play.google.com/store/apps/details?id=com.bdword.e2bdictionary"
                                                    title="Android App">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/android_app.webp" onerror="this.onerror=null; this.src=';
                                                $big_html .= "'" . $contentUrl . "site_image/android_app.jpg'";
                                                $big_html .= '" alt="Android App" width="100%" loading="lazy"></a></div>';
                                    
                                                $big_html .= '<div><a href="https://play.google.com/store/apps/details?id=com.bdword.e2bdictionary"
                                                    title="iPhone App">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/iphone_app.webp"onerror="this.onerror=null; this.src=';
                                            ...
                                            if ($main_array['lang'] == 'bengali') {
                                                $big_html .= '<div><a href="https://chrome.google.com/webstore/detail/bdword-english-to-bengali/cogjmeckpkinhnidokapabgaoelhkbcl"
                                                    ...
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/chrome_extension.webp"onerror="this.onerror=null; this.src=';
                                                $big_html .= "'" . $contentUrl . "site_image/chrome_extension.jpg'";
                                                $big_html .= '" alt="Chrome Extension" width="100%" loading="lazy"></a></div>';
                                    
                                                $big_html .= '<div><a href="' . $main_array['baseurl'] . 'english-to-' . $main_array['lang']. '-dictionary-learn-translations"
                                                    title="Common Translations">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="' . $contentUrl. 'site_image/common_translations.webp"onerror="this.onerror=null; this.src=';
                            ...
                            <fieldset>
                                <legend>
                                    <h2>Topic Wise Words</h2>
                                </legend><div class="fieldset_body inner_details" style = "word-break: initial;">';
                                        $rand = rand(1, 12700);
