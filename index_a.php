        ...
        <div class="content_wrapper">
            ...
            <div class="search_fld">
                <form autocomplete="off" name="new_form" action="<?= $main_array['baseurl'] ?>" id="new_form">
                    <input type="text" id="q" name="q" value="<?= $main_array['q'] ?>" onfocus="this.value=''"
                           autocomplete="off" required placeholder="Type English word/phrase"
                                    ...
                                    while ($movdict_row = mysqli_fetch_assoc($movdict_query)) {
										...
										<div class="card">
                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    ...
                                                    title="<?= addslashes($movdict_row['text']) ?>" style="width: 100%;">
...
<script type="text/javascript">
    ...
    function edValueKeyPress() {
        ...
        if (search.value.length > 2) {
            load('getEngSug_a.php?q=' + search_value, search_value, function (xhr) {
