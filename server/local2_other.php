...
foreach($other as $row1){
    ...
    $data = file_get_contents('https://content2.mcqstudy.com/local/' . strtolower($lang) . '/' . $row1.'.txt');
       ...
       $array = array_filter($array);
        foreach($array as $value){
            ...
            file_put_contents('/mnt/volume_sgp1_05/all_cache_files/'.$lang.'/'.$lang.'-to-english-dictionary-two-letter-'.str_replace(' ','-',$value), $this_html);
        }       
}
...
<head>
    ...
    <link rel="canonical" href="'.$base_url.$lang.'-to-english-dictionary-two-letter-'.$word.'"/>
    ...
    <meta property="og:url" content="'.$base_url.$lang.'-to-english-dictionary-two-letter-'.$word.'"/>
...
<div id="site_wrapper">
   ...
   $big_html .= '<script src="' . $apiurl . 'local_page_js.js?v=4"></script>';
