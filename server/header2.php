...
<?php endif; ?>
    ...
    /*Accordion CSS*/
    .accordion_collapse{overflow:hidden;clear:both}.accordion_collapse h4{margin:0;padding:8px;border:1px solid #eaeaea;-moz-border-radius:4px;-webkit-border-radius:4px;border-radius:4px;background-color:#fafafa;outline:none;cursor:pointer}.custom-accordion-content{padding:15px 8px;display:none}.icon_right{font-size:0.8rem;color:#009385!important;float:right}
