...
// <!-- Blog List Start    -->
            ...
            for (var b in data_parsed.page_section.blog_list){
                ...
                // blog_section_html +='<a href="'+window.url+'/english-to-'+window.lang+'-dictionary-blog-2" title="'+b+'"><img src="'+image_link+'">'+b+'</a>';
...
// <!-- Learn Grammar START -->
            ...
            //     // var route_link = data_parsed.learn_section.grammar[y].route_link;
...
// <!-- Learn Words Everyday start   -->
        ...
        for(var n in data_parsed.word){
            ...
            var route = data_parsed.word[n].href;

            learn_new_words +='<a href="'+route+'" title="'+n+'"><img src="'+image_link+'">'+n+'</a>';
        }
