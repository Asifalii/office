...
/*========= Learn Prepositions banners start ============ */
    ...
    function get_images(){
        ...
        $images_array_links=[
                            ...
                            'Android App' => array('https://server2.mcqstudy.com/bw-static-files/site_image/android_app.webp',$domainName.'/store/apps/details?id=com.bdword.e2bdictionary'),
                            'iPhone App' => array('https://server2.mcqstudy.com/bw-static-files/site_image/iphone_app.webp',$domainName.'/us/app/english-'.$lang.'-dictionary/id1213381239?ls=1'),
                            'Chrome Extension' => array('https://server2.mcqstudy.com/bw-static-files/site_image/chrome_extension.webp',$domainName.'/webstore/detail/english-to-'.$lang.'-dictio/cogjmeckpkinhnidokapabgaoelhkbcl'),
                        ...
                        // $data_array['bellow_Sections']['all_images_links'] = $images_array_links;
...
// <!-- 500+ Common Translations Start        -->
    ...
    
    {
        ...
        $content .= '</div><button class="btn_default5 bdr_radius2"><a href="'.$domainName.'/english-to-'.$lang.'-dictionary-learn-translations">More</a></button>';
