...
$sql = "select * from restrictad where word = '".strtolower($_GET['q'])."'";
...
// main loop starts
foreach($cache_lang_array as $lang_key=>$lang_val){

$_GET['q'] = strtolower($_GET['q']);
$_GET['lang'] = strtolower($lang_key);
// $_GET['lang'] = 'kannada';
            ...
            <button class='btn_default2 bdr_radius2'>
             ...
             if ($main_array['lang'] == 'bengali') {
                 ...
                 if (!empty($country)) {
                     ...
                     $big_html .= '<div class="box_wrapper2 custom_bgcolor">
                     <div class="inner_wrapper"><button class="btn_default3 bdr_radius2"><a href="https://newspaperlinks.xyz/newspaper/' . $string . '" target="_blank"><img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="'. $contentUrl.'img/newspaper-icon.png" width="30px" height="30px" alt="icon" loading="lazy"><label>All ' . ucfirst($main_array['lang']) . ' Newspapers</label></a>
                     </div>
             </div>';
...
file_put_contents('/mnt/volume_sgp1_05/single_files/english-to-'.$_GET['lang'].'-meaning-'.strtolower(str_replace(' ','-',$_GET['q'])), $big_html);

// exec('aws s3 cp /var/www/single_files/english-to-'.$_GET['lang'].'-meaning-'.strtolower(str_replace(' ','-',$_GET['q'])).' s3://'.$lang_val.' --content-type text/html --acl public-read');
