...
$array = array('ALBANIAN'=>'sq',
  ...
  foreach($array as $k=>$v){
	  ...
	  echo '"'.strtolower($k).'"=>array("'.$k.'"),<br>';
	  
	// $file = file_get_contents('https://www.google.com/uds/modules/elements/keyboard/'.$v.'.js');
	  
	// $myfile = fopen("js/".$v.".js", "w") or die("Unable to open file!");
	// fwrite($myfile, $file);
