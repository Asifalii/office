...
Also Available Different ' . ucfirst($lang) . ' keyboard layout To Typing ' . ucfirst($lang) . ' To English Translate And English To ' . ucfirst($lang) . ' Converter. ' . "Let's Enjoy It...";
    ...
    <link rel="canonical" href="<?= $base_url. $lang .'-to-english-dictionary' ?>"/>
        ...
        <div class="left_content">
            ...
            if ($q and $lang and $show_local_mean == true) {
                ...
                <div class="box_wrapper">
                    <fieldset>
                        <legend><h1><?= ucfirst($lang) ?> to English <?= $q ?></h1></legend>
                        <div class="fieldset_body inner_details">
                            ...
                            if (mysqli_num_rows($mquery) != 0) {
                                while ($row = mysqli_fetch_assoc($mquery)) {
                                    echo '<span><a href="' . $base_url . 'english-to-' . $lang . '-meaning-' . $row['word'] . '">' . $row['word'] . ' :: ' . $row['mean'] . '</a></span>';
                                }
                            } else {
                                echo '<span>No word meaning found for: ' . $q . '</span>';
                            }
            ...
            <div class="box_wrapper">
				...
				<legend><span class="custom_font2"><h2>Browse English Words</h2></span></legend>
				...
				if ($other === false) {
					...
					if(!empty($other)){
				 $array = explode(',',$other);
				 echo ' <fieldset class="main-area1"><legend><span class="custom_font2"><h2>Browse '.str_replace("Bengali", "Bangla", $ulang).' Words</h2></span></legend>';
