...
$allowed_pages = ['local_lang','local'];
...
//lang dictionary
echo "php local.php '".$lang."'******".$lang."-to-english-dictionary\n";
echo "php browse-words.php '".$lang."'******browse-".$lang."-to-english-words\n";

foreach(range('a','z') as $row){
echo "php local1.php '".$lang."' '".$row."'******english-to-".$lang."-dictionary-letter-".$row."\n";
echo "php browse-words.php '".$lang."' '".$row."'******browse-english-to-".$lang."-word-".$row."\n";
...
echo "php browse-words.php '".$lang."' '1' '".$value."'******browse-english-to-".$lang."-dictionary-two-word-".$value."\n";
	}
}
